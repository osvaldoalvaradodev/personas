...
switch ($fila['id_formato_boleta']) {
  case '1':
    ...
    break;
   case '2':
     $formatoboleta = '<span class="label label-info">CI - Factura</span>';
    break;
     case '3':
     $formatoboleta = '<span class="label label-warning">Convenio</span>';
    break;
     case '4':
     $formatoboleta = '<span class="label label-default">Exentos</span>';
    break;
  default:
    $formatoboleta = '<span class="label label-primary">Boleta</span>';
    break;
